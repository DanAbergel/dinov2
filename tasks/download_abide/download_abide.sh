...
#
# Usage:
#   sbatch tasks/download_abide/download_abide.sh
#   LIMIT=5 sbatch tasks/download_abide/download_abide.sh           # test
#   DATASETS=abide1,abide2 sbatch tasks/download_abide/download_abide.sh
# =====================================================================
...
export TASK_DIR="$OFFICIAL_DIR/tasks/download_abide"

...
#   source $VENV/bin/activate && python3 tasks/inspect_corpus/inspect_corpus.py
#
# Usage:
#   sbatch tasks/inspect_corpus/inspect_corpus.sh
# =====================================================================
...
TASK_DIR="$OFFICIAL_DIR/tasks/inspect_corpus"

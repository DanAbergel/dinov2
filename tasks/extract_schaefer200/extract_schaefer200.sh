...
# Usage:
#   cd ~                                                          # or anywhere
#   sbatch /sci/.../FAIR_official/tasks/extract_schaefer200/extract_schaefer200.sh
#   # -> outputs in ~/schaefer200_output/
#
#   # Or test on a few subjects first:
#   LIMIT=5 sbatch tasks/extract_schaefer200/extract_schaefer200.sh
# =====================================================================
...
export TASK_DIR="$OFFICIAL_DIR/tasks/extract_schaefer200"

...
#   sbatch tasks/data_prep/compute_t_fixed/compute_t_fixed.sh
#   MARGIN=2 sbatch tasks/data_prep/compute_t_fixed/compute_t_fixed.sh   # safety margin
# =====================================================================
...
TASK_DIR="$OFFICIAL_DIR/tasks/data_prep/compute_t_fixed"

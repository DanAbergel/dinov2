...
#
# Usage:
#   sbatch tasks/data_prep/download_aomic/download_aomic.sh
#   LIMIT=5 sbatch tasks/data_prep/download_aomic/download_aomic.sh           # test 5 subjects per dataset
#   DATASETS=piop1 sbatch tasks/data_prep/download_aomic/download_aomic.sh    # PIOP1 only
# =====================================================================
...
export TASK_DIR="$OFFICIAL_DIR/tasks/data_prep/download_aomic"

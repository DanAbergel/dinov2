...
#
# Usage:
#   sbatch tasks/data_prep/download_hcp/download_hcp.sh
#   # or with custom limit / all-sessions:
#   LIMIT=50 ALL=1 sbatch tasks/data_prep/download_hcp/download_hcp.sh
# =====================================================================
...
export TASK_DIR="$OFFICIAL_DIR/tasks/data_prep/download_hcp"

...
\footnotesize *Source data: `outputs/probes/probe_{adni,hcp}_<run_name>_iter<iter>.json` -- generated by `slurm_jobs/probe_{adni,hcp}.sh`, aggregated by `python3 scripts/summarize_probes.py`.*
